...
namespace cliUtils {
  ...
  std::string getCertificateFile( void );
  
  std::string getKeyFile( void );

  void showCEError( glite::ce::monitor_client_api::cemon_exceptions::CEException& );
  
  void showError( AbsException& );

  std::string checkCEMonURL( const std::string& );
